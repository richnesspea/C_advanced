...
void Intern::showMe(){
    this->showInfo();
    std::cout << "The majors: " <<  this->getMajors() << std::endl;
    std::cout << "The semester: " << this->getSemester() << std::endl;
    std::cout << "The university name: " << this->getUniversity_name() << std::endl;
    std::cout << "Certificates of Intern: " << std::endl;
